                    ...
                    <CardContent>
                      <div className="text-sm space-y-3">
                        <p className="text-muted-foreground">
                          Analysis of customer feedback data reveals positive
                          sentiment trends...
                        </p>
                        <p className="text-muted-foreground">
                          Key insights include improved satisfaction scores and
                          reduced response times...
                        </p>
                        <p className="text-muted-foreground">
                          Recommendations focus on scaling successful
                          initiatives and addressing pain points...
                        </p>
                      </div>
                    </CardContent>
                  </Card>
